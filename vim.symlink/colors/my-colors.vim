...
if &background == "light"
    ...
    hi Normal gui=NONE guifg=#000000 guibg=#424242
...
elseif &background == "dark"
    hi Boolean gui=NONE guifg=#f986d2 guibg=NONE
    hi ColorColumn gui=NONE guifg=NONE guibg=#1a1a1a
    hi Comment gui=NONE guifg=#078688 guibg=NONE
    hi Conceal gui=NONE guifg=#f43491 guibg=NONE
    hi Conditional gui=NONE guifg=#d381f8 guibg=NONE
    hi Constant gui=NONE guifg=#7d7d7d guibg=NONE
    hi Cursor gui=reverse guifg=#edea0c guibg=NONE
    hi CursorColumn gui=NONE guifg=NONE guibg=#1a1a1a
    hi CursorLine gui=NONE guifg=#e6e6e6 guibg=#404040
    hi CursorLineNr gui=NONE guifg=#6e6e6e guibg=NONE
    hi DiffAdd gui=NONE guifg=NONE guibg=#078307
    hi DiffChange gui=NONE guifg=NONE guibg=#888607
    hi DiffDelete gui=NONE guifg=#bababa guibg=#881607
    hi DiffText gui=NONE guifg=NONE guibg=#f8f677
    hi Directory gui=NONE guifg=#0c90ed guibg=NONE
    hi Error gui=NONE guifg=#000000 guibg=#ed900c
    hi ErrorMsg gui=NONE guifg=NONE guibg=#884e07
    hi FoldColumn gui=NONE guifg=#5e5e5e guibg=NONE
    hi Folded gui=NONE guifg=#6e6e6e guibg=NONE
    hi Ignore gui=NONE guifg=NONE guibg=NONE
    hi IncSearch gui=NONE guifg=NONE guibg=#ed2e0c
    hi LineNr gui=NONE guifg=#5e5e5e guibg=NONE
    hi MatchParen gui=NONE guifg=#ed900c guibg=#000000
    hi ModeMsg gui=NONE guifg=NONE guibg=NONE
    hi MoreMsg gui=NONE guifg=NONE guibg=NONE
    hi NonText gui=NONE guifg=#5e5e5e guibg=NONE
    hi Normal gui=NONE guifg=#bababa guibg=#999999
    hi Number gui=NONE guifg=#ed900c guibg=NONE
    ...
    hi Special gui=NONE guifg=#72d0f8 guibg=NONE
    hi SpecialKey gui=NONE guifg=#5e5e5e guibg=NONE
    hi SpellBad gui=undercurl guisp=NONE guifg=NONE guibg=#8b1d50
    hi SpellCap gui=undercurl guisp=NONE guifg=NONE guibg=NONE
    ...
    hi Statement gui=NONE guifg=#f8f677 guibg=NONE
    hi StatusLine gui=NONE guifg=#999999 guibg=#075088
    hi StatusLineNC gui=NONE guifg=#6e6e6e guibg=#262626
    hi StorageClass gui=NONE guifg=#f87c77 guibg=NONE
    hi String gui=NONE guifg=#0ce98d guibg=NONE
    hi TabLine gui=NONE guifg=#6e6e6e guibg=#262626
    hi TabLineFill gui=NONE guifg=NONE guibg=#262626
    hi TabLineSel gui=NONE guifg=#0ceded guibg=#262626
    hi Title gui=NONE guifg=#fafafa guibg=NONE
    hi Todo gui=standout guifg=#edea0c guibg=#000000
    hi Type gui=NONE guifg=#0c90ed guibg=NONE
    hi Underlined gui=NONE guifg=NONE guibg=NONE
    hi VertSplit gui=NONE guifg=#333333 guibg=NONE
    hi Visual gui=NONE guifg=#404040 guibg=#f8cf77
    hi VisualNOS gui=NONE guifg=NONE guibg=NONE
    hi WarningMsg gui=NONE guifg=NONE guibg=#ed2e0c
